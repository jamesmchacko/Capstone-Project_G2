...
#include <WiFi.h>
#include <BlynkSimpleEsp32.h> // Header for Blynk
#include <OneWire.h>
...
char blynkAuth[] = "5vdJ192fLhBpL3TKDg6p3O9bVtO7oG8m"; // 
BlynkTimer sendTimer;
// Set password to "" for open networks.
char ssid[] = "2101_rogers";
...
void setup(){
  ...
  Serial.begin(115200); // Initialize Serial
   // Blink LED for 5 seconds to signal start of initialization
  ...
  if (!pox.begin(Wire, I2C_SPEED_FAST)) { //Use default I2C port, 400kHz speed
    ...
    Serial.println("Setup initialized! Enter any key to continue...");
     // Blink LED for 3 seconds to mark initialization
